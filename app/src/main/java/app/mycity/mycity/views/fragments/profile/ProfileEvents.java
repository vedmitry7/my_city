...
public class ProfileEvents extends android.support.v4.app.Fragment implements TabStacker.TabStackInterface, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.profile_events_fragment, container, false);
        ButterKnife.bind(this, view);
        return view;
    }

    public static ProfileEvents createInstance(String name, String userId) {
        ProfileEvents fragment = new ProfileEvents();
    ...
    private void loadFeed(int offset) {
        if(mayRestore){
            ...
            ApiFactory.getApi().getAllEventsByUserId(App.accessToken(), App.chosenCity(),search,"1", offset, getArguments().getString("profileId")).enqueue(new retrofit2.Callback<ResponseContainer<ResponseWall>>() {
                @Override
